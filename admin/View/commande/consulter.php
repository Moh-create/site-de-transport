        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0 mt-3">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              ?>
                <a href="modifier.html?idCommande=<?php echo htmlspecialchars($commande->getIdCommande()); ?>" class="btn btn-primary stretched-link mt-3">Modifier l'état de la commande</a>            
            </div>
