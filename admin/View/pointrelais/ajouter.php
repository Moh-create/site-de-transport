...
<body>
  ...
  <main id="main" style="padding-top: 15%;">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Ajouter un point relais</h2>
    </div>
    <div class="container">

      <form action="../../forms/ajouterPointRelais.php" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control"name="adresseRue" required>
        </div>

        <div class="form-group">
          <label for="exampleInputPassword1">Ville</label>
          <input type="text" class="form-control"name="adresseVille">
        </div>

        <div class="form-group">
          <label for="exampleInputPassword1">Adresse Postal ou Etat</label>
          <input type="text" class="form-control"name="adressePostal">
        </div>
