        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0 mt-3">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4 class="title"><?php echo htmlspecialchars($sav->getNom()); ?></h4>
              <p class="description">Numero de télephone : <?php echo htmlspecialchars($sav->getNumero()); ?></p>
              <p class="description mb-5">Ville : <?php echo htmlspecialchars($sav->getVille()->getNomVille()); ?></p>

              <a class="btn btn-primary mt-5" href="modifier.php?idSav=<?php echo $sav->getId(); ?>" role="button" style="bottom: 2%; position:absolute; float:right;">Modifier</a>
            </div>
